...
//  完成context迪欧response和request的代理
...
module.exports = class Application extends Emitter {
  ...
  constructor(options) {
    ...
    * */
    this.middleware = [];
    this.context = Object.create(context);  //对象级别继承（继承一个最干净的对象）
  ...
  callback() {
    ...
    */
    ...
    const handleRequest = (req, res) => {
      // 调用createContext创建上下文对象,传入的是http请求对象和http响应对象（左半边关系图）
  ...
  //处理http请求 传入的是上下文 和 一个对中间件进行处理的预备函数（ 请求过来偶会被调用；）
